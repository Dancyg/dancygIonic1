...
angular.module('starter.controllers', ['ngSanitize'])
  ...
  .controller("LoginCtrl", function ($scope, $http, $ionicPopup, $state, Loading, $rootScope ) {
  ...
  .controller("BlogCtrl", function ($scope, $http, $ionicPopup, Loading, $sce, $ionicPopover, Categories,  $ionicScrollDelegate, $rootScope, Alert) {
